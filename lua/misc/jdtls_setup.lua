...
function M:setup()
	...
	local workspace_dir = "/home/manuel/Workspace/" .. project_name
	local config = {
		cmd = {
			...
			"-jar",
			"/home/manuel/.local/share/jdtls/plugins/org.eclipse.equinox.launcher_1.7.100.v20251111-0406.jar",

			"-configuration",
			"/home/manuel/.local/share/jdtls/config_linux/",
			"-data",
			workspace_dir,
		},
